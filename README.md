...
Значок приложения только объясняет, как добавить виджет. Проверять нужно сам виджет.
...
Приложение никуда не отправляет ваш аккаунт: проверка — это обычные HTTPS-запросы к фиксированному списку сайтов. Лицензия — [MIT](LICENSE).
